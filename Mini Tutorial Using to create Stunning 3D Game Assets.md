...
* Reference image that will be used to create our 3D model available in the repository.
...
![](docs/asset-library-import/Blender Interface.png)
...
![](docs/asset-library-import/ImportingImageReference.png)
...
![](docs/asset-library-import/RelocatingImageBackground.png)
...
![](docs/asset-library-import/Reposition.png)

![](docs/asset-library-import/RotationReference.png)
...
![](docs/asset-library-import/FinalRotationReference.png)
...
![](docs/asset-library-import/WireframeMode.png)
...
![](docs/asset-library-import/ChangingCube.png)
...
![](docs/asset-library-import/CubeEdition.png)

Once we have positioned all our vertices, we will have the following result.

![](docs/asset-library-import/FirstApproach.png)
...
![](docs/asset-library-import/Addingmorevertices.gif)
...
![](docs/asset-library-import/AddingMoreVertices.png)
...
![](docs/asset-library-import/RepositionVertices.png)

### 💡 TIPS: To reposition our working view if we've moved our model with the mouse's scroll key, simply press the 1 key on the numpad to return to our working position.
...
![](docs/asset-library-import/PerspectiveYAxis.png)
...
![](docs/asset-library-import/MoreElements.png)
...
![](docs/asset-library-import/AddCylinder.png)
...
![](docs/asset-library-import/RotatingCylinder.png)
...
![](docs/asset-library-import/ToggleXRay.png)
...
![](docs/asset-library-import/AddingCut.png)
...
![](docs/asset-library-import/AddingMoreCutCylinder.png)
...
![](docs/asset-library-import/ExtrudingParts.png)
...
![](docs/asset-library-import/Telescopic.png)
...
![](docs/asset-library-import/MoreTelescopic.png)
...
![](docs/asset-library-import/BackPiece.png)
...
![](docs/asset-library-import/FinishingSeveralPieces.png)
...
![](docs/asset-library-import/MirrorModifier.png)
...
![](docs/asset-library-import/Clipping.png)
...
![](docs/asset-library-import/Addon.png)

And to check the changes in our model, something like this should appear.

![](docs/asset-library-import/CheckAddon.png)
...
![](docs/asset-library-import/KnifeTool.png)
...
![](docs/asset-library-import/ConfirmingMirrorModifier.png)
...
![](docs/asset-library-import/AutoMirror.png)
...
![](docs/asset-library-import/RemovingFaces.png)
...
![](docs/asset-library-import/RemovingMoreFaces.png)
...
![](docs/asset-library-import/SnapOption.png)
...
![](docs/asset-library-import/BackFaces.png)
...
![](docs/asset-library-import/ScaleAdjustment.png)

![](docs/asset-library-import/ScaleAdjustment1.png)
...
![](docs/asset-library-import/UVProject.png)
...
![](docs/asset-library-import/MarkSim.png)
...
![](docs/asset-library-import/UVEditing.png)
...
![](docs/asset-library-import/ImageTextureandColorGrid.png)

![](docs/asset-library-import/ImageTextureandColorGrid1.png)
...
![](docs/asset-library-import/NewTextureMaterial.png)
...
![](docs/asset-library-import/ImageTexture.png)
...
![](docs/asset-library-import/TexturePaint.png)
...
![](docs/asset-library-import/PaintMask.png)
...
![](docs/asset-library-import/SeparationPart.png)
...
![](docs/asset-library-import/ColorPalette.png)
...
![](docs/asset-library-import/MoreColorPalette.png)
...
![](docs/asset-library-import/MenuOption.png)
...
![](docs/asset-library-import/SavingTextureandFile.png)
...
![](docs/asset-library-import/ShadeSmooth.png)
...
![](docs/asset-library-import/DrawOption.png)
...
![](docs/asset-library-import/BrushSettings.png)
...
![](docs/asset-library-import/FinalResult.png)
...
![](docs/asset-library-import/ExportModel.png)
...
![](docs/asset-library-import/ImportingModelandTextureHWDE.png)

![](docs/asset-library-import/ImportingIntoHWDE.png)

![](docs/asset-library-import/BlendervsHWDE.png)
